...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("FDR Core TX utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  fdreserve-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded fdreserve transaction") + "\n" +
                               "  fdreserve-tx [options] -create [commands]   " + _("Create hex-encoded fdreserve transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded fdreserve transaction
