...
/* *** BEGIN OBFUSCATION MAGIC - fdreserve **********
    ...
    if (fMasterNode) {
        ...
        BOOST_FOREACH (const CTransaction& txCollateral, vecSessionCollateral) {
            ...
            /*
                ...
                allow endless transaction that would bloat fdreserve and make it unusable. To
                stop these kinds of attacks 1 in 10 successful transactions are charged. This
                adds up to a cost of 0.001 fdreserve per transaction on average.
            */
            if (r <= 10) {
...
void CObfuscationPool::GetDenominationsToString(int nDenom, std::string& strDenom)
{
    ...
    //
    // bit 0 - 100fdreserve+1 ( bit on if present )
    // bit 1 - 10fdreserve+1
    // bit 2 - 1fdreserve+1
    // bit 3 - .1fdreserve+1
    // bit 3 - non-denom
...
void ThreadCheckObfuScationPool()
{
    ...
    RenameThread("fdreserve-obfuscation");
