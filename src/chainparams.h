 ...
 * fdreserve system. There are three: the main network on which people trade goods
...
public:
    ...
    // const std::vector<unsigned char>& fdreserveDevKey() const { return vfdreserveDevKey; }
    // const std::vector<unsigned char>& fdreserveFundKey() const { return vfdreserveFundKey; }
...
protected:
    ...
    // std::vector<unsigned char> vfdreserveDevKey;
    // std::vector<unsigned char> vfdreserveFundKey;
    // int nDevFee;
    // int nFundFee;
    int nDefaultPort;
